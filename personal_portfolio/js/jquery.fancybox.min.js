      ...
      n.extend(h.prototype, {
          ...
          createGroup: function (t) {
              ...
              n.each(i, function (t, i) {
                  ...
                  n.isPlainObject(i)
                      ...
                      ? ((a = n(i)), (u = a.data()), (u = n.extend({}, u, u.options || {})), (u.$orig = a), (l.src = u.src || a.attr("href")), l.type || l.src || ((l.type = "inline"), (l.src = i)))
                      : (l = { type: "html", src: i + "" }),
          ...
          activate: function () {
              ...
              n(".fancybox-container").each(function () {
                  ...
                  (t.current || t.isIdle) && (t.$refs.container.index() > 0 && t.$refs.container.prependTo(e.body), t.update(), t.updateControls()),
                      ...
                      t.on(r, function (i) {
                          (!i || !i.originalEvent || (t.is(i.originalEvent.target) && "z-index" != i.originalEvent.propertyName)) &&
                              ...
                              n.isPlainObject(e)
                                  ? e.scaleX !== o &&
                                    e.scaleY !== o &&
                                    (t.css("transition-duration", "0ms"), (e.width = Math.round(t.width() * e.scaleX)), (e.height = Math.round(t.height() * e.scaleY)), (e.scaleX = 1), (e.scaleY = 1), n.fancybox.setTranslate(t, e))
                                  : s !== !0 && t.removeClass(e),
                              n.isFunction(a) && a(i));
                      }),
              ...
              i.type ||
                  ...
                  h
                      ? ((i.src = f),
                        ...
                        "iframe" === h &&
                            (t.extend(!0, i.opts, { iframe: { preload: !1, attr: { scrolling: "no" } } }), (i.contentProvider = d), (i.opts.slideClass += " fancybox-slide--" + ("gmap_place" == d || "gmap_search" == d ? "map" : "video"))))
                      : f && (i.type = "image"));
          });
      });
